...
public class Controller {
    //recuperation du csv
    private CSVReader init = new CSVReader("src/main/ressources/sae/s201/data.csv");
    ...
    public ArrayList<String> getLieux(List<CSVReader> list) { // fonction qui prend en entrée une liste de seismes et qui renvoie une liste contenant tout les lieux presents
        ArrayList<String> lieux = new ArrayList();
        for (CSVReader seisme : list) {
    ...
    public List<CSVReader> triData(boolean bannee, boolean blieu) {         // trie les données en fonction de l'année et/ou du lieu selon les specifications
        if (bannee) {
    ...
    public ArrayList<Integer> GraphIntens(List<CSVReader> liste) { // genere la liste qui servira a afficher le graphe montrant le nombre de seismes de chaque intensité par année
        ArrayList<Integer> intensL = new ArrayList<>(Collections.nCopies(18, 0));
        for (CSVReader seisme : liste) {
    ...
    public ArrayList<ArrayList<Integer>> GraphEvo(List<CSVReader> list) { // genere la liste qui servira a afficher le graphe montrant le nombre de seismes par année en fonction du lieu
